...
The stable custom-domain path serves the actual Beta game bytes, not the generic One Day Games shell. The public room backend is the Cloudflare Worker `trash-dice-beta-room` at `wss://trash-dice-beta-room.play-onedaygames.workers.dev/beta-ws`. Public two-client QA passed on 2026-05-19, including host invite controls on a 320px viewport, create/join/start, explicit `Roll For First` opening roll-off, deterministic Player 2 first turn, Player 2-to-Player 1 handoff readiness, gameplay rolls, full nearby-human round-win events for Green/Player 2 on both browser clients, Player 2 small-phone roll-panel clearance, peer-left visual recovery after Player 2 sleeps/disconnects, public active-game layout at 1024x980, 768x920, 390x664, and 320x568 viewports, title/tagline visibility without overlap, trash-can wordmark visibility/sizing on tablet and phone, CPU-to-player handoff timing across lid and trash outcomes, and protocol checks for guest starts, out-of-turn rolls, and duplicate-turn rolls. The production CPU-to-player handoff is 250ms as of `a1b0045`; public QA on `042a9d1` measured opening roll-off resolution at 2634ms, Green-to-Yellow nearby readiness at 274ms, full nearby Green round-win spill duration at 4420ms versus the one-player CPU cap of 2800ms, CPU lid handoff at 260ms, CPU trash handoff at 268ms, and verified peer-left recovery with the room panel visible, `gameStarted=false`, multiplayer inactive, roll disabled, game area hidden, no leftover travel/payout effects, and the trash can not topmost. Public Beta SHA-256 was `d4e328a2502d4c67056374e374316eddb822b572275e1f6afa146a1e47edc4d7`. Slack release note: https://onedaygames.slack.com/archives/C0AU29TPER4/p1779246902600699. Do not share a future Beta build until `qa-beta-public-build.ps1 -RunMultiplayerQa` passes for the exact public URL and Alpha Complete still byte-matches its frozen SHA.
